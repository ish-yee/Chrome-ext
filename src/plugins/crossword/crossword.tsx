...
const PictureConfigScreen = ({
  ...
  const [url, setUrl] = useState(currentConfig?.url ?? "https://www.dictionary.com/e/crossword/");
  ...
  return (
    <div className="PictureWidget-config">
      <div className="field">
        <label>{t("url")}:</label>
        <Input
          placeholder="https://www.dictionary.com/e/crossword/"
          value={url}
...
const CrosswordPlugin = ({
  ...
  return (
    <div className="PictureWidget">
      <button id="crossword" onClick={redirect3}>
        <img
...
const widgetDescriptor = {
  id: "widget",
  get name() {
    return translate("crossword");
  },
  configurationScreen: PictureConfigScreen,
  mainScreen: CrosswordPlugin,
  mock: () => {
    return (
      <CrosswordPlugin
        instanceId="mock"
