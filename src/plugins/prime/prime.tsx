...
const PictureConfigScreen = ({
  ...
  const [url, setUrl] = useState(currentConfig?.url ?? "https://www.primevideo.com/region/eu/offers/nonprimehomepage/ref=dv_web_force_root");
  ...
  return (
    <div className="PictureWidget-config">
      <div className="field">
        <label>{t("url")}:</label>
        <Input
          placeholder="https://www.primevideo.com/region/eu/offers/nonprimehomepage/ref=dv_web_force_root"
          value={url}
...
const PrimePlugin = ({
  ...
  return (
    <div className="PictureWidget">
      <button id="prime" onClick={redirect3}>
        <img
          src="https://m.media-amazon.com/images/I/413+SVFO39L.png"
          alt="prime"
          width="80%"
        />
      </button>
...
const widgetDescriptor = {
  id: "widget",
  get name() {
    return translate("prime");
  },
  configurationScreen: PictureConfigScreen,
  mainScreen: PrimePlugin,
  mock: () => {
    return (
      <PrimePlugin
        instanceId="mock"
